...
export const API_BASE_URL = "http://192.168.1.9:5002";
...
export const ADMIN_USERS_API = `${API_BASE_URL}/admin/users`;
export const ADMIN_USERS_PENDING_API = `${API_BASE_URL}/admin/users/pending`;
export const adminUserApproveApi = (userId) => `${API_BASE_URL}/admin/users/${userId}/approve`;
export const adminUserRejectApi = (userId) => `${API_BASE_URL}/admin/users/${userId}/reject`;
export const adminUserActivateApi = (userId) => `${API_BASE_URL}/admin/users/${userId}/activate`;
export const adminUserDeactivateApi = (userId) => `${API_BASE_URL}/admin/users/${userId}/deactivate`;
export const adminUserRoleApi = (userId) => `${API_BASE_URL}/admin/users/${userId}/role`;

export const FORMS_API = `${API_BASE_URL}/forms`;

export const ADMIN_ROLES = ["hod", "iqac_coordinator"];
...
export async function getAllUsers(token) {
  const data = await adminRequest(ADMIN_USERS_API, token);
  return data.data || [];
}
...
export async function getPendingUsers(token) {
  const data = await adminRequest(ADMIN_USERS_PENDING_API, token);
  return data.data || [];
}
...
export async function approveUser(token, userId) {
  return adminRequest(adminUserApproveApi(userId), token, { method: "PUT" });
}

export async function rejectUser(token, userId) {
  return adminRequest(adminUserRejectApi(userId), token, { method: "PUT" });
}

export async function activateUser(token, userId) {
  return adminRequest(adminUserActivateApi(userId), token, { method: "PUT" });
}

export async function deactivateUser(token, userId) {
  return adminRequest(adminUserDeactivateApi(userId), token, { method: "PUT" });
}
...
export async function changeUserRole(token, userId, role) {
  return adminRequest(adminUserRoleApi(userId), token, {
    method: "PUT",
    body: { role },
  });
}
...
/* =========================================================
   FORMS — UPDATE FORM
   ========================================================= */
export async function updateForm(token, formId, formData) {
